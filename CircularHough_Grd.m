...
%           Remarks: speed up, optimized using the gradient threshold
%           diwaker.jha@nano.ku.dk
%           Revision: Mar. 03, 2013
...
prm_grdthres = 10;% median(img(:)); %(20/100)*max(img(:));
prm_fltrLM_R = 10;
prm_multirad = 0.7;
func_compu_cen = true;
...
%prm_grdthres = median(img(:)); %(20/100)*max(img(:));
